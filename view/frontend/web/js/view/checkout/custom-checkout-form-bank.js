...
define([
    ...
    'Magepow_CheckoutCustomForm/js/model/checkout/custom-checkout-form-bank'
    ...
    return Component.extend({
        ...
        initialize: function () {
            var self = this;
            this._super();
            formData = this.source.get('customCheckoutFormBank');
            var formDataCached = cartCache.get('custom-form');
            if (formDataCached) {
                formData = this.source.set('customCheckoutFormBank', formDataCached);
            }
        ...
        saveCustomFields: function() {
            ...
            this.source.trigger('customCheckoutFormBank.data.validate');

            if (!this.source.get('params.invalid')) {
                var formData = this.source.get('customCheckoutFormBank');
